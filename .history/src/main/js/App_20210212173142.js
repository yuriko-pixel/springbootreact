            ...
            <input type="button" onClick={()=>getUsers()}/>
            {
               users.map(i=>{return (
                <form method="post" action="/user/{i.id}">
                	...
                	<li key={Math.random()}><input type="text" name="name" defaultValue={i.name}/></li>
                	<li key={Math.random()}><input type="text" name="surname" defaultValue={i.surname}/></li>
                	<li key={Math.random()}><input type="text" name="email" defaultValue={i.email}/></li>
                	<li key={Math.random()}><input type="text" name="username" defaultValue={i.username}/></li>
                	<li key={Math.random()}><input type="text" name="password" defaultValue={i.password}/></li>
