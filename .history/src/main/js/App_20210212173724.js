            ...
            <input type="button" onClick={()=>getUsers()}/>
            {
               users.map(i=>{return (
                <form method="post" action="/user/{i.id}">
                	<li key={i.id}>
                        <input type="text" name="id" defaultValue={i.id}  onChange={handleInputChange}/>
                    </li>
                	<li key={i.name}>
                        <input type="text" name="name" defaultValue={i.name} onChange={handleInputChange}/>
                    </li>
                	<li key={i.surname}>
                        <input type="text" name="surname" defaultValue={i.surname} onChange={handleInputChange}/>
                    </li>
                	<li key={i.email}>
                        <input type="text" name="email" defaultValue={i.email} onChange={handleInputChange}/>
                    </li>
                	<li key={i.username}>
                        <input type="text" name="username" defaultValue={i.username} onChange={handleInputChange}/>
                    </li>
                	<li key={i.password}>
                        <input type="text" name="password" defaultValue={i.password}/>
                    </li>
