    ...
    return (
        <div>
            <input type="button" onClick={()=>getUsers()}/>
            {
               users.map(i=>{return (
                    <div key={Math.random()} >
                        <input type="text" key={Math.random()} name="key" onChange={handleInputChange}>{i.id}</input>
                        <input type="text" key={Math.random()} name="name" onChange={handleInputChange}>{i.name}</input>
                        <input type="text" key={Math.random()}  name="surname" onChange={handleInputChange}>{i.surname}</input>
                        <input type="text" key={Math.random()}  name="email" onChange={handleInputChange}>{i.email}</input>
                        <input type="text" key={Math.random()}  name="username" onChange={handleInputChange}>{i.username}</input>
                        <input type="text"key={Math.random()}  name="password" >{i.password}</input>
