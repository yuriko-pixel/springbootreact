    ...
    return (
        <div>
            <input type="button" onClick={()=>getUsers()}/>
            {
               users.map(i=>{return (
                    <div key="hey">
                        <input type="text" key={i.id} name="key" defaultValue={i.id}  onChange={handleInputChange}/>
                        <input type="text" key={i.name} name="name" defaultValue={i.name} onChange={handleInputChange}/>
                        <input type="text" key={i.surname} name="surname" defaultValue={i.surname} onChange={handleInputChange}/>
                        <input type="text" key={i.email} name="email" defaultValue={i.email} onChange={handleInputChange}/>
                        <input type="text" key={i.username} name="username" defaultValue={i.username} onChange={handleInputChange}/>
                        <input type="text" key={i.password} name="password" defaultValue={i.password}/>
                	    <input key="key" type="submit">Submit</input>
                 </div>
                    )})
            }
