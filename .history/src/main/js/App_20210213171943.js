...
function App() {
    ...
    function handleInputChange(e, targetValue) {
      ...
      async function postData(url = 'http://localhost:8080/user/save', 
                              data = {JSON.parse({id: r_id, name: r_name, surname: r_surname, username: r_username, email: r_email, password: r_password})}) {
