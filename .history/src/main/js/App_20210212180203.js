            ...
            <input type="button" onClick={()=>getUsers()}/>
            {
               users.map(i=>{return (
                    <div key={Math.random()} >
                        ...
                        <input type="text" key={Math.random()} name="name" onChange={handleInputChange}/>
                        <input type="text" key={Math.random()}  name="surname" onChange={handleInputChange}/>
                        <input type="text" key={Math.random()}  name="email" onChange={handleInputChange}/>
                        <input type="text" key={Math.random()}  name="username" onChange={handleInputChange}/>
                        <input type="text"key={Math.random()}  name="password" />
