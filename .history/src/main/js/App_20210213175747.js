...
function App() {
    ...
    function handleInputChange(e, targetValue) {
      ...
      async function postData(url = end, data = JSON.parse({"id": r_id, "name": r_name, "surname": r_surname, "username": r_username, "email": r_email, "password": r_password})) {
    ...
    return (
        ...
        <form>
            ...
            <input type="submit" value="submit" onSubmit={postData()}></input>
        </form>
        </div>
    )
  }
